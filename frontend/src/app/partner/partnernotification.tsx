...
import { FaBell, FaEnvelope, FaReply, FaUser } from "react-icons/fa";

// Example notification data with type and user info
...
const PartnerNotification = () => {
  ...
  // Only show notifications of type "all" and "user"
  let notifications = allNotifications.filter(n =>
    n.type === "all" || n.type === "user"
  );
  ...
  // Dummy email for demonstration (in real app, fetch user email)
